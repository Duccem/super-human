...
const ResultItem = React.forwardRef(
  (
    ...
    return (
      <div ref={ref} className={`px-4 py-3 flex items-center justify-between cursor-pointer relative z-10`}>
        {active && (
          <motion.div
            layoutId="kbar-result-item"
            className="bg-gray-200 dark:bg-gray-700 border-l-2 border-black dark:border-white absolute inset-0 !z-[-1]"
            transition={{
              duration: 0.14,
              type: 'spring',
              ease: 'easeInOut',
        ...
        <div className="flex gap-2 items-center relative z-10">
          ...
          <div className="flex flex-col">
            ...
            {action.subtitle && <span className="text-sm text-gray-600 dark:text-gray-400">{action.subtitle}</span>}
          </div>
        </div>
